...
var EXAM_TITLES = {
  ...
  'usnco-2026-natl-1':   ['USNCO 2026 National Part I'],
...
/* ── 정답표 — 보내온 점수를 여기서 **다시 센다** ────────────────────────
   채점은 브라우저에서 일어나고 그 결과가 그대로 이리 온다. 여태 창구에는
   정답표가 없어서, 보내온 수가 맞는지 가릴 방법이 아예 없었다. 누구든
   아무 이름으로 만점을 올릴 수 있고, 그런 줄 몇 개면 다른 학생의 석차·
   백분위·또래 정답률이 전부 흔들린다. 실제로 그런 일이 있었다 — 검사가
   진짜 창구로 제출해서 학생 아닌 줄이 모집단에 들어갔었다.

   ⚠ **다시 세어 보고 어긋나면 적어 둘 뿐, 점수는 안 고친다.** 창구가 말없이
     갈아 치우면 그게 더 위험하다 — 나중에 전원정답으로 돌린 회차에서는
     옛 줄이 통째로 「틀린 것」이 되고, 왜 바뀌었는지 알 길이 없다.
     어긋난 것은 `검증기록` 시트에 남긴다. 무엇을 할지는 사람이 정한다.

   글자 하나가 한 문항이다.  '*' 전원정답 · '3' 3번만.
   인정 답이 둘 이상인 자리는 `many` 에 따로 적는다.

   ⚠ 손으로 고치지 않는다 — `python3 tools/gen_gas_keys.py --write` 가 만든다. */
var EXAM_KEYS = {
  'JMChC 모의고사 10회': {n:60, acc:'2321332234442233231441411332433434222243244334434*4142123431'},
  'JMChC 모의고사 11-1회': {n:60, acc:'1123232333?2432111221312332433222311321322124343112221343334', many:{11:'34'}},
  'JMChC 모의고사 11회': {n:60, acc:'432112431132212143333332313322333224412241341144333211211431'},
  'JMChC 모의고사 12회': {n:60, acc:'4342324421243141432321444344231433234443322211?2412233323343', many:{47:'23'}},
  'JMChC 모의고사 13회': {n:60, acc:'134432231441411344324421244434431221121312314411213343424442'},
  'JMChC 모의고사 14회': {n:60, acc:'123133442234214232143324334443444234322313111134142211231211'},
  'JMChC 모의고사 1회': {n:60, acc:'442233224113133433122344213224312341433121323242223444331311'},
  'JMChC 모의고사 2회': {n:60, acc:'221124422234443432131334413433231134333244334443232142413334'},
  'JMChC 모의고사 3회': {n:60, acc:'423233323113234232434412333241432342212421232142233133433133'},
  'JMChC 모의고사 4회': {n:60, acc:'13124244222133?32442433344234131313*334213323311144241322424', many:{15:'12'}},
  'JMChC 모의고사 5회': {n:60, acc:'414444412444343233324243343434443142434422344311433112432234'},
  'JMChC 모의고사 6회': {n:60, acc:'444424232342213313124322334323221423341421124132433444323421'},
  'JMChC 모의고사 7회': {n:60, acc:'22232234411223224321113132232224*1342434342432414433412211?3', many:{59:'12'}},
  'JMChC 모의고사 8회': {n:60, acc:'1111322423433212221241443341?3342242223321121122233341214112', many:{29:'23'}},
  'JMChC 모의고사 9회': {n:60, acc:'3244443324134422141311441123124441344224443241*44*222411234*'},
  'KMChC 2009': {n:60, acc:'314421434142213244424221232444?3332332223234434423*434324434', many:{31:'23'}},
  'KMChC 2010': {n:60, acc:'3411323444332144132424423114143324412*342*?22114312443233122', many:{43:'12'}},
  '화올 2015': {n:60, acc:'2444222434311234311*3313114222242441243423331123434113442423'},
  '화올 2016': {n:60, acc:'34412434122334342111324112343434324132244214422?444323141133', many:{48:'34'}},
  '화올 2017': {n:60, acc:'43144234111431433443213131424333124322443443212213314321133*'},
  '화올 2018': {n:60, acc:'24214334314123214113112434?413422*43323234124443234113233231', many:{27:'12'}},
  '화올 2019': {n:60, acc:'2234323214123323131313*244111423142442424*211123342333211232'},
  '화올 2021': {n:60, acc:'31122343241224332233321432412123144?44234214342?24411224314*', many:{36:'34', 48:'34'}},
  '화올 2022': {n:60, acc:'333133341332323423133332442242221423113433311142341323122314'},
  '화올 2023': {n:60, acc:'443432324441111342233131442143114222132234311333334433212322'},
  '화올 2024': {n:60, acc:'443242422313114233122413331414422433232213124311132422134143'},
  '화학1 1-2단원 모의고사': {n:60, acc:'213133134133241133332444233131412323242421212123332443241232'},
  '화학1 1-2단원 모의고사 (동형)': {n:60, acc:'213133134133241133332444233131412323242421212123332443241232'},
  '화학1 1-3단원 모의고사': {n:60, acc:'224223224243331232424431422343143322334442331131111442424323'},
  '화학1 1-3단원 모의고사 (동형)': {n:60, acc:'224223224213331232424431422343143322334442331131111442424323'},
  '화학1 1단원 모의고사': {n:60, acc:'424221233424212133143434433211232133434441133242332131332132'},
  '화학2 1-3단원 모의고사': {n:60, acc:'113122331433233234441234134214342323111234343244244233242343'},
  '화학2 1단원 모의고사': {n:60, acc:'1223323444213232123211214333212?2324234222333324121241421212', many:{32:'23'}},
  '화학2 총괄평가': {n:60, acc:'414242331433233234441234134214342323111234343244244233242343'},
};

/* 보내온 답안을 정답표로 다시 센다. 모르는 회차·길이가 다른 답안이면 null
   (판정하지 않는다 — 모르면서 「틀렸다」고 하면 안 된다). */
function _verifyCorrect_(examTitle, ans) {
  var k = EXAM_KEYS[String(examTitle == null ? '' : examTitle)];
  if (!k) return null;
  var s = String(ans == null ? '' : ans).replace(/^'/, '');
  if (s.length !== k.n) return null;
  var c = 0;
  for (var i = 0; i < k.n; i++) {
    var want = (k.many && k.many[i + 1]) || k.acc.charAt(i);
    if (want === '*' || want === '?' || want.indexOf(s.charAt(i)) >= 0) c++;
  }
  return c;
}

/* 어긋난 줄만 `검증기록` 에 남긴다. 성적기록 시트의 열 폭은 안 건드린다 —
   거기에 열을 하나 더 붙이면 옛 줄을 읽는 자리가 전부 흔들린다. */
function _logVerify_(ss, d, sent, again) {
  try {
    var sh = ss.getSheetByName('검증기록');
    if (!sh) {
      sh = ss.insertSheet('검증기록');
      sh.appendRow(['적힌 때', '시험', '학생이름', '보내온 맞은개수', '다시 센 맞은개수', '답안']);
      sh.getRange(1, 1, 1, 6).setFontWeight('bold');
      sh.setFrozenRows(1);
    }
    sh.appendRow([new Date(), d.exam, d.name, sent, again, "'" + String(d.answers || '')]);
  } catch (e) {}          /* 남기다 실패해도 채점은 계속돼야 한다 */
}
...
function doPost(e) {
  ...
  try {
    ...
    /* ── 보내온 점수를 여기서 다시 센다 ─────────────────────────────
       고치지 않는다. 어긋난 줄만 `검증기록` 에 남겨 사람이 보게 한다. */
    try {
      var again = _verifyCorrect_(d.exam, d.answers);
      var sent = Number(d.correct);
      if (again !== null && isFinite(sent) && again !== sent) _logVerify_(ss, d, sent, again);
    } catch (eV) {}
...
/* ── 한 학생의 전 회차 이력 ────────────────────────────────────────────
   ...
   이름은 **공백을 지우고** 견준다. '박바다' 과 '박 바다' 은 한 사람이다 —
   시트에도 그렇게 갈려 들어가 있다. */
...
function doGet(e) {
  ...
  /* ── 검사가 남긴 줄만 지운다 ────────────────────────────────────────
     ...
     손으로 지우면 빠뜨린다 — 이름만으로는 못 가른다. '이아람' 은 진짜 줄과
...
var EXAM_COHORT = {
  ...
  'KMChC 2025 제2차 · 일반': { q: 50, base: [24,33,34,35,38,40,40,50] },
  'KMChC 2025 제2차 · 심화': { q: 50, base: [] },
  'KMChC 2025 제1차 · 일반': { q: 50, base: [32,34,38,41,42,50] },
  'KMChC 2025 제1차 · 심화': { q: 50, base: [22,25,29,31,35,38,49] },
  ...
  '화학1 1단원 모의고사': { q: 60, base: [15,15,16,16,20,20,20,20,20,20,20,21,21,22,23,23,24,24,25,25,26,26,26,27,27,27,28,29,29,29,29,29,30,30,30,30,31,31,31,31,31,31,31,31,32,32,33,33,33,33,33,33,33,33,34,34,34,34,34,34,34,34,34,35,35,35,35,35,36,36,36,36,36,37,37,38,38,38,38,38,38,38,38,39,39,39,39,39,39,40,41,41,41,41,42,42,42,42,42,42,42,42,42,43,43,43,44,45,45,45,45,45,45,46,46,46,46,46,46,46,47,47,47,47,47,48,48,48,48,48,50,50,51,51,51,51,51,52,55] },
  '화학1 1-2단원 모의고사': { q: 60, base: [15,16,19,19,20,20,21,22,22,22,22,22,24,24,24,24,25,25,25,25,26,26,26,27,27,28,28,28,28,29,29,29,29,29,30,30,30,30,30,30,31,31,31,32,32,32,32,32,33,33,34,34,34,34,34,34,34,35,35,35,35,35,35,35,36,36,36,36,36,37,37,37,37,37,37,38,38,38,38,38,38,39,39,39,40,40,41,41,41,41,41,42,42,42,42,43,43,43,43,43,43,43,43,43,44,44,44,44,44,45,45,45,45,45,45,46,46,46,46,46,46,47,47,47,47,47,47,48,48,48,49,49,51,51,52,54,55,55,56,56,56,56,56,57,57] },
  '화학1 1-2단원 모의고사 (동형)': { q: 60, base: [15,16,19,19,20,20,21,22,22,22,22,22,24,24,24,24,25,25,25,25,26,26,26,27,27,28,28,28,28,29,29,29,29,29,30,30,30,30,30,30,31,31,31,32,32,32,32,32,33,33,34,34,34,34,34,34,34,35,35,35,35,35,35,35,36,36,36,36,36,37,37,37,37,37,37,38,38,38,38,38,38,39,39,39,40,40,41,41,41,41,41,42,42,42,42,43,43,43,43,43,43,43,43,43,44,44,44,44,44,45,45,45,45,45,45,46,46,46,46,46,46,47,47,47,47,47,47,48,48,48,49,49,51,51,52,54,55,55,56,56,56,56,56,57,57] },
  '화학2 1단원 모의고사': { q: 60, base: [9,9,13,13,14,15,16,17,17,17,19,19,20,20,21,21,22,22,23,23,23,23,24,24,24,24,24,24,24,25,25,25,25,25,26,27,28,28,28,28,28,29,29,29,29,30,30,30,31,31,31,32,32,33,33,33,33,34,34,34,34,34,34,35,35,35,35,35,35,35,35,36,36,36,36,36,36,37,37,37,37,37,37,38,38,38,39,39,39,39,39,39,39,39,39,39,39,40,40,40,40,41,41,41,41,41,41,41,41,41,42,42,42,42,42,42,43,43,43,43,44,44,44,45,45,45,45,45,45,46,46,46,46,46,46,47,47,47,47,48,48,50,50,50,51,51,51,51,52,52,53,54,55,56,58] },
  '화학2 1-3단원 모의고사': { q: 60, base: [24,25,35,36,38,39,41,41,42,43,45,45,48,49,51,52,54] },
  '화학2 총괄평가': { q: 60, base: [22,24,26,27,28,29,29,33,34,34,35,35,35,36,36,36,37,37,38,39,39,39,39,39,40,40,40,41,42,42,42,43,44,45,45,45,46,46,46,46,46,47,48,48,48,49,49,49,49,50,51,51,51,51,52,52,53,53,54,55,56] },
  '조준모의고사 0회': { q: 60, base: [] },
};
...
/* 고친 값을 시트에 한 번에 반영하고, 지울 행은 아래→위로 지운다.
   ...
   (김가온·전솔·최자두)이 사라졌다 — 저장은 됐다가 뒤늦게 끝난 옛 재계산이
...
var MSG_EXAMS = {
  ...
  'KMChC 2026 제1차 · 일반': { topic: '반응속도·산화환원·분자의모양·고체·분자간인력', mode: 'perc' },
  'KMChC 2026 제1차 · 심화': { topic: '산화환원·반응속도·고체·분자의모양·열화학', mode: 'perc' },
  'KMChC 2025 제2차 · 일반': { topic: '반응속도·분자의모양·화학평형·산과염기·열역학', mode: 'perc' },
  'KMChC 2025 제2차 · 심화': { topic: '반응속도·화학평형·산화환원·열화학', mode: 'perc' },
  'KMChC 2025 제1차 · 일반': { topic: '산화환원·기체·원자모형·분자의모양·반응속도', mode: 'perc' },
  ...
  'USNCO 2026 National Part I': { topic: '반응속도·탄소화합물·전지·액체,용액·원소분석장치', mode: 'perc' },
  '화학1 1단원 모의고사': { topic: '원자의구조·몰과개수·기체·몰과질량', mode: 'perc' },
  '화학1 1-2단원 모의고사': { topic: '원자모형·몰과양적관계·원소의기원·방사성붕괴·양자수', mode: 'perc' },
  '화학1 1-2단원 모의고사 (동형)': { topic: '원자모형·몰과양적관계·원소의기원·방사성붕괴·양자수', mode: 'perc' },
  '화학1 1-3단원 모의고사': { topic: '주기율·쌍극자모멘트·양적관계·원자모형·원소의기원', mode: 'perc' },
  '화학1 1-3단원 모의고사 (동형)': { topic: '주기율·양적관계·원자모형·쌍극자모멘트·원소의기원', mode: 'perc' },
  '화학2 1단원 모의고사': { topic: '분자간인력·분자운동속도·고체의밀도·고체의구조', mode: 'perc' },
  '화학2 1-3단원 모의고사': { topic: '용액·엔탈피·고체·기체·엔트로피', mode: 'perc' },
  '화학2 총괄평가': { topic: '용액·엔탈피·고체·기체·엔트로피', mode: 'perc' },
