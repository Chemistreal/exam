...
LINK = [('C18-001', 0, 'M02955'), ('C18-002', 0, 'M02956'), ('C18-003', 0, 'M02957'),
        ('C18-004', 0, 'M02958'), ('C18-005', 0, 'M02959'), ('C18-006', 0, 'M02960'),
        ('C18-007', 0, 'M02961'), ('C18-008', 0, 'M02962'), ('C18-009', 0, 'M02963'),
        ('C18-010', 0, 'M02964')]
...
def main():
    ...
    print('T18 P1 링크 — 각도 %d · 개념 주의 %d건' % (n, len(NOTES)))
