...
LINK = [('C18-001', 2, 'M02995'), ('C18-002', 2, 'M02996'), ('C18-003', 2, 'M02997'),
        ('C18-004', 2, 'M02998'), ('C18-005', 2, 'M02999'), ('C18-006', 2, 'M03000'),
        ('C18-007', 2, 'M03001'), ('C18-008', 2, 'M03002'), ('C18-009', 2, 'M03003'),
        ('C18-010', 2, 'M03004')]
...
def main():
    ...
    print('T18 P5 링크 — 각도 %d · 개념 주의 %d건' % (n, len(NOTES)))
