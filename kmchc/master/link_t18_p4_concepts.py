...
LINK = [('C18-011', 1, 'M02985'), ('C18-012', 1, 'M02986'), ('C18-013', 1, 'M02987'),
        ('C18-014', 1, 'M02988'), ('C18-015', 1, 'M02989'), ('C18-016', 1, 'M02990'),
        ('C18-017', 1, 'M02991'), ('C18-018', 1, 'M02992'), ('C18-019', 1, 'M02993'),
        ('C18-020', 1, 'M02994')]
...
def main():
    ...
    print('T18 P4 링크 — 각도 %d · 개념 주의 %d건' % (n, len(NOTES)))
