...
LINK = [('C18-001', 1, 'M02975'), ('C18-002', 1, 'M02976'), ('C18-003', 1, 'M02977'),
        ('C18-004', 1, 'M02978'), ('C18-005', 1, 'M02979'), ('C18-006', 1, 'M02980'),
        ('C18-007', 1, 'M02981'), ('C18-008', 1, 'M02982'), ('C18-009', 1, 'M02983'),
        ('C18-010', 1, 'M02984')]
...
def main():
    ...
    print('T18 P3 링크 — 각도 %d · 개념 주의 %d건' % (n, len(NOTES)))
