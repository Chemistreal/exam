...
무엇으로 가르나
  그린 크롭은 「문제 NN」 아래에 **폭을 가득 채운 가로 실선**을 긋는다.
  자른 크롭에는 그 줄이 없다 — 시험지에는 그런 선이 없기 때문이다.
  그림 하나만 보면 되므로 답지도 PDF 도 안 읽는다.
...
NO_SOURCE_YET = {
    's1e3u232r0e5-2', 's2p0c114x5f2-2', 's2u0z3u5x6h6-2', 's2z6y5b253u5-2',
    's4o0j400e3g0-2', 's4w000h6h6l0-2', 's6w2y5y2i485-2',
}
