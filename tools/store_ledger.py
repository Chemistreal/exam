...
KNOWN = {
    ...
    'exam.submit.stucktold.v1': '「확인 안 된 답안」 경보를 몇 건까지 말했는지. 건수가 늘 때만 다시 말한다',
    'exam.submit.pending.v1':   '아직 시트에 닿았는지 못 확인한 답안. 제출 **전에** 적고, '
                                '다음에 제출 화면을 열 때 한 번씩 더 보낸다(세 번까지). '
                                'no-cors 라 닿았는지 알 수 없어서 지우지 않는다 — 조용히 잃는 것보다 낫다',
