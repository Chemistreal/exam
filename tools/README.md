...
7. **"A가 크면 B도 이렇다"는 서열 문항은 실제 측정값으로 확인한다.** 이론이 옳아도
   그 물질에서는 뒤집힐 수 있고, 방향이 맞아도 **간격이 좁으면 변별력이 없다**
   (NO₂⁻ 124 pm 대 NO₃⁻ 126 pm는 측정 오차 수준이라 hwol-2023 16번을
   CO 113 / CO₂ 116 / CO₃²⁻ 129 / CH₃OH 143 pm 계열로 교체함). (jmchc-13 48번이 결합성 σ에 전자를 채우면 결합이
