...
⚠ **이 두 줄을 나란히 세우면 안 된다**(2026-08-11 에 고침). 예전에는
  ...
  어느 앱이나 하는 일이고 **같은 학생인지 견주는 자리가 아니다.**
      ...
      exam            맞춰 보는 키 2곳 (collapse)
      DT              맞춰 보는 키 4곳 (collapse)
      KMChC           **0곳** — 입력칸 다듬기 2곳뿐
      study64-report  **0곳** — 입력칸 다듬기 3곳뿐

  «규칙이 갈렸다» 와 «규칙이 없다» 는 다른 이야기다. 앞엣것은 맞추면 되고,
  뒤엣것은 **필요한지부터** 묻는 일이다 — KMChC 는 리포트가 제출 하나에
  딸리고 학생의 지난 회차를 잇지 않는다. 이을 것이 없으면 맞출 것도 없다.
